...
### Scope
To be defined in further detail by the project owner. Split out as its own phase (owner's explicit choice, 2026-09-04) rather than folded into Phase 17, since it is a real content feature — likely a model, a submission form, an admin/moderation step, and a public display page — not an SEO mechanism itself, even though testimonial content can support Phase 17's SEO goals later (e.g. review-style structured data). See `DECISIONS.md`.
