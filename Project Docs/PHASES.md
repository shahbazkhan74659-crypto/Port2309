...
**Status: Complete**, for this scope. Implemented and verified 2026-09-04 — see `DECISIONS.md`'s "Phase 18 Public Feedback" entry for the full implementation detail and verification steps. **Not yet deployed** — `core/migrations/0033_feedback.py` has only run against local dev, not Neon; see `TASKS.md`.
